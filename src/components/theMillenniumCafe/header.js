      ...
      <div className="millennium-cafe-s1">
        <div className="millennium-cafe-s1-text">
          ...
          <div className="millennium-cafe-s1-text-p">
            <a style={{color: '#306B46'}} href="https://www.google.co.uk/maps/search/The+Millennium+Centre,+The+Chase,+Dagenham+Road,+Rush+Green,++Romford+RM7+0SS/@51.554071,0.1761473,16z/data=!3m1!4b1?hl=en">
