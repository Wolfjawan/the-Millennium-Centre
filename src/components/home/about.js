    ...
    return (
      <div className="home-about" id="home-about">
        ...
        <div>
          ...
          <p> Dragonflies are fierce hunters of flying insects.The dragonfly larvae lives under water and will eat most other water creatures and small fish.
         </p>
          <h3>
            Butterflies and wild bees
            </h3>
          <p>The area has been planted with grasses and flowers so there is lots of nectar and pollen to attract wildlife.Butterflies and wild bees abound and the area is home to wild bees that live alone and not in crowds like honeybees.
        </p>
          <h3>
            Black poplars
           </h3>
          <p> There are 7 mature black poplar trees at Eastbrookend.There are only around 2, 000 black poplars in the whole of the country and somehow these 7 trees have managed to survive the gravel digging and dumping in the area.
